      ...
      <section className="px-6 py-16 md:py-24 max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
        <div className="flex-1 space-y-8 z-10 text-center lg:text-left">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
            <button className="w-full sm:w-auto flex justify-center items-center gap-2 bg-blue-700 text-white px-7 py-3.5 rounded-xl font-semibold hover:bg-blue-800 transition-all shadow-lg shadow-blue-200 hover:-translate-y-0.5">
              Get Started <ArrowRight className="w-4 h-4" />
            </button>
            <button className="w-full sm:w-auto bg-slate-100 text-slate-700 px-7 py-3.5 rounded-xl font-semibold hover:bg-slate-200 transition-all">
              Explore Marketplace
            </button>
          </div>
        </div>
        <div className="flex-1 relative w-full max-w-lg mx-auto lg:max-w-none h-[400px] lg:h-[500px]">
          ...
          <div className="absolute -bottom-6 -left-4 lg:bottom-10 lg:-left-12 bg-white p-5 rounded-2xl shadow-xl flex items-center gap-5 border border-slate-50 animate-bounce" style={{animationDuration: '3s'}}>
            ...
            <div>
              <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-0.5">Active Tenders</p>
              <p className="text-2xl font-extrabold text-slate-800 leading-none">1,284</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="col-span-1 md:col-span-2 bg-white rounded-[2rem] p-8 shadow-sm hover:shadow-xl transition-shadow flex flex-col justify-between">
              <div>
                ...
                <h3 className="text-2xl font-bold text-slate-800 mb-3">Government Buyer</h3>
              ...
              <div className="h-48 md:h-56 rounded-2xl overflow-hidden bg-slate-100">
            ...
            <div className="flex flex-col gap-6">
              <div className="bg-white rounded-[2rem] p-8 shadow-sm hover:shadow-xl transition-shadow flex-1 flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-xl font-bold text-slate-800 mb-3">Seller</h3>
              ...
              <div className="bg-white rounded-[2rem] p-8 shadow-sm hover:shadow-xl transition-shadow flex-1 flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-xl font-bold text-slate-800 mb-3">OEM</h3>
                  <p className="text-slate-600 mb-6 text-sm leading-relaxed">
            ...
            <div className="col-span-1 md:col-span-3 bg-[#42618A] rounded-[2rem] p-8 md:p-10 shadow-lg text-white flex flex-col md:flex-row items-center justify-between gap-10 mt-2">
              <div className="max-w-xl">
                ...
                <button className="bg-white text-[#42618A] px-6 py-3 rounded-xl text-sm font-bold hover:bg-slate-50 transition-colors shadow-sm">
                  Access Data Room
                </button>
              </div>
              <div className="w-full md:w-1/2 flex items-end gap-4 opacity-10 h-32">
                <div className="h-16 w-1/3 bg-white rounded-t-xl"></div>
                <div className="h-32 w-1/3 bg-white rounded-t-xl"></div>
                <div className="h-24 w-1/3 bg-white rounded-t-xl"></div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="relative flex flex-col md:flex-row justify-between items-center gap-12 md:gap-4">
            ...
            <div className="relative z-10 flex flex-col items-center max-w-[220px] mx-auto bg-white pt-2">
              <div className="w-20 h-20 rounded-2xl bg-white border-2 border-blue-600 shadow-xl shadow-blue-50 flex items-center justify-center text-blue-600 mb-6 relative">
                ...
                <span className="absolute -top-3 -right-3 bg-blue-600 text-white text-[10px] font-bold w-7 h-7 rounded-full flex items-center justify-center border-[3px] border-white">01</span>
              </div>
              <h4 className="font-bold text-slate-800 mb-2 text-lg">Government posts tender</h4>
            ...
            <div className="relative z-10 flex flex-col items-center max-w-[220px] mx-auto bg-white pt-2">
              <div className="w-20 h-20 rounded-2xl bg-white border border-slate-100 shadow-xl shadow-slate-100 flex items-center justify-center text-slate-600 mb-6 relative hover:border-blue-200 transition-colors">
                ...
                <span className="absolute -top-3 -right-3 bg-slate-100 text-slate-600 text-[10px] font-bold w-7 h-7 rounded-full flex items-center justify-center border-[3px] border-white">02</span>
              </div>
              <h4 className="font-bold text-slate-800 mb-2 text-lg">Sellers bid</h4>
            ...
            <div className="relative z-10 flex flex-col items-center max-w-[220px] mx-auto bg-white pt-2">
              <div className="w-20 h-20 rounded-2xl bg-white border border-slate-100 shadow-xl shadow-slate-100 flex items-center justify-center text-slate-600 mb-6 relative hover:border-blue-200 transition-colors">
                ...
                <span className="absolute -top-3 -right-3 bg-slate-100 text-slate-600 text-[10px] font-bold w-7 h-7 rounded-full flex items-center justify-center border-[3px] border-white">03</span>
              </div>
              <h4 className="font-bold text-slate-800 mb-2 text-lg">L1 selection</h4>
            ...
            <div className="relative z-10 flex flex-col items-center max-w-[220px] mx-auto bg-white pt-2">
              <div className="w-20 h-20 rounded-2xl bg-white border border-slate-100 shadow-xl shadow-slate-100 flex items-center justify-center text-slate-600 mb-6 relative hover:border-blue-200 transition-colors">
                ...
                <span className="absolute -top-3 -right-3 bg-slate-100 text-slate-600 text-[10px] font-bold w-7 h-7 rounded-full flex items-center justify-center border-[3px] border-white">04</span>
              </div>
              <h4 className="font-bold text-slate-800 mb-2 text-lg">Order execution</h4>
              <p className="text-xs text-slate-500 leading-relaxed px-2">End-to-end milestone tracking and digital payment settlement.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-white border-t border-slate-100 py-10 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="text-center md:text-left">
             <span className="text-xl font-bold text-slate-800 block mb-3">
              GovMarket
            </span>
          ...
          <div className="flex flex-wrap justify-center gap-x-6 gap-y-3 text-xs text-slate-500 font-medium">
